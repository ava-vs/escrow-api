...
export class NotificationServiceFixed {
  private db;
  ...
  async createNotification(
    ...
    try {
      ...
      console.log('Creating notification:', { notificationId, userId, type: validType, title });
      ...
      return result[0] || { id: notificationId, userId, type: validType, title, message };
    } catch (error) {
